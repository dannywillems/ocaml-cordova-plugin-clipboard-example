...
This is an example of the binding to the *clipboard cordova plugin*. See the
...
You need to install the plugin *cordova-universal-clipboard*. The Makefile contains
...
* init_plugins: initialize plugins you need. Contains cordova-universal-clipboard
  for this project.
